...
def handle_scanning():
    ...
    # Rotate slowly to maintain blocking position
...
def handle_aligning():
    global current_state
    # Small turn to line up for blocking
    drive_train.set_turn_velocity(20, PERCENT)
...
def handle_approaching():
    ...
    # Close in just enough to block the opponent
...
def handle_attacking():
    ...
    arm_drive.set_velocity(40, PERCENT)
...
def handle_retreating():
    ...
    # Back up before returning to manual control
    drive_train.drive_for(REVERSE, 15, INCHES)
    current_state = RobotState.MANUAL
