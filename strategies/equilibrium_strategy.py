...
def handle_scanning():
    ...
    # Balanced scan velocity approximating Nash equilibrium
    drive_train.set_turn_velocity(45, PERCENT)
...
def handle_target_found():
    ...
    # Moderate drive speed for balanced offense/defense
    drive_train.set_drive_velocity(45, PERCENT)
...
def handle_attacking():
    ...
    # Attack duration tuned around the equilibrium
    arm_drive.spin(REVERSE)
    wait(1.5, SECONDS)
    arm_drive.stop()
    arm_drive.spin(FORWARD)
