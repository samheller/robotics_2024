...
def handle_scanning():
    ...
    # Spin faster to quickly locate scoring objects
    drive_train.set_turn_velocity(70, PERCENT)
...
def handle_aligning():
    global current_state
    # Quick turn to face the detected target
    drive_train.set_turn_velocity(70, PERCENT)
...
def handle_approaching():
    ...
    drive_train.set_drive_velocity(60, PERCENT)
...
def handle_attacking():
    ...
    # Extended attack to ensure scoring
    arm_drive.spin(REVERSE)
    wait(2, SECONDS)
    arm_drive.stop()
    arm_drive.spin(FORWARD)
...
def handle_retreating():
    ...
    # Drive backward before handing control back to the driver
